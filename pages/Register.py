...
# Global dicts for async WebRTC thread state
...
if name and nim:
    ...
    # -------------------------------------------------------------
    # BUG FIX: Replaced cv2.VideoCapture loop entirely with WebRTC
    # -------------------------------------------------------------
    def video_frame_callback(frame: av.VideoFrame) -> av.VideoFrame:
        ...
        with global_lock:
            # Initialize thread-safe tracking
    ...
    st.info("Allow camera access. Keep your face in view until the counter hits 30/30.")
    ...
    if st.button("Finish & Train Model"):
...
<div style="
    ...
    box-shadow: 0 10px 40px rgba(16, 185, 129, 0.3); margin: 1rem 0; border: 3px solid #059669;
">
